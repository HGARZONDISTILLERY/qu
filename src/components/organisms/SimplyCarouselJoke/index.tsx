...
interface SimplyCarouselJokeProps {
  randomJokeIsLoading: boolean
  randomJokeData: Joke[] | undefined
}

const SimplyCarouselJoke = ({ randomJokeIsLoading, randomJokeData }: SimplyCarouselJokeProps) => {
  ...
  >
    {!randomJokeIsLoading && randomJokeData?.map((joke) => (
